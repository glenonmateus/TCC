...
\begin{figure}[!htb]
 ...
 \begin{minipage}{0.4\textwidth}
  ...
  \includegraphics[scale=.32]{arquitetura_pytbull_ids_dmz.png}
  \legend{Fonte: \cite{pytbull}}
 \end{minipage}
\end{figure}
...
\begin{figure}[!htb]
 ...
 \begin{minipage}{0.4\textwidth}
  ...
  \includegraphics[scale=.38]{arquitetura_pytbull_ips.png}
  \legend{Fonte: \cite{pytbull}}
 \end{minipage}
 \hfill
 \begin{minipage}{0.4\textwidth}
  ...
  \includegraphics[scale=.38]{arquitetura_pytbull_ips_dmz.png}
  \legend{Fonte: \cite{pytbull}}
 \end{minipage}
\end{figure}
