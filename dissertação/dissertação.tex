...
Metasploit é um \textit{framework} de código aberto cujo principio básico é desenvolver e executar \textit{exploit} contra alvos remotos, podendo fornecer uma lista de vulnerabilidades existentes no alvo. É uma ferramenta que combina diversos \textit{exploits} dentro de umlocal e fácil utilização, ideal para levantamento de segurança de serviços e servidores.  
