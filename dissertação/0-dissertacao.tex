...
\preambulo{Trabalho de Conclusão de Curso submetida à banca examinadora do programa de graduação em Ciência da Computação da UFPA para obtenção do grau de Bacharel em Ciência da Computação}
