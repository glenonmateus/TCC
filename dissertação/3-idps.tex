...
Existe quatro componentes no Snort: O \textit{Sniffer}, o Pré-processador, o Motor de Detecção e Módulo de Saída. A \autoref{fig_snort-componentes} mostra a disposição dos componentes \cite{kohlenberg2007snort}.

\begin{figure}[!htb]
  \centering
  \includegraphics[scale=0.6]{snort_componentes}
  \caption{Componentes do Snort} \label{fig_snort-componentes}
\end{figure}
