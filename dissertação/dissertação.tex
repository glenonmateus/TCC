...
%falar um pouco do fator humano para geração de senha

Existem três métodos mais usados por programas de quebra de senha: ataques de dicionário (ou lista de palavras), ataques híbridos e ataques de força-bruta.

Em um ataque de força bruta, toda e qualquer combinação possível é testada. Esse é o método mais lento.
