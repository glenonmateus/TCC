...
Nessa seção será apresentada os principais conceitos objetivando entender melhor o que é segurança da informação. \cite{esr-gestao}:
...
\subsection{\texit{Exploit}} \label{sec:exploit}
