...
\subsection{Web - Desfiguração de páginas}
...
\subsection{Consumo dos Recursos de Hardware (Memória, Processamento)}
\subsection{Taxa de Detecção}
\subsection{Número de Falsos Positivos/Negativos}
% ----------------------------------------------------------
