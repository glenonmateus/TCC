...
\begin{figure}[htb]
    ...
    \includegraphics[scale=.45]{arquitetura_pytbull_remote.png}
...
\begin{figure}[htb]
    ...
    \includegraphics[scale=.45]{arquitetura_pytbull_ids_dmz.png}
    \legend{Fonte: \cite{pytbull}}
...
\begin{figure}[htb]
    ...
    \includegraphics[scale=.45]{arquitetura_pytbull_ips.png}
    \legend{Fonte: \cite{pytbull}}
...
\begin{figure}[htb]
    ...
    \includegraphics[scale=.45]{arquitetura_pytbull_ips_dmz.png}
    \legend{Fonte: \cite{pytbull}}
