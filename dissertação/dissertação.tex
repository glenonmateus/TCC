...
\subsection{Worm}
\subsection{Trojan}
\section{Ferramentas para Avaliação de Segurança}
...
\begin{figure}[!htb]
  ...
  \subfloat[NIDS Passivo]{
    \includegraphics[scale=0.5]{nids_passivo.png}
    \label{nids-passivo}
  }
  \quad
  \subfloat[NIDS Ativo]{
    \includegraphics[scale=0.5]{nids_ativo.png}
    \label{nids-ativo}
  }
