...
No primeiro teste de Scan, usou-se o parâmetro -F, habilitando a modo \textit{fast} do Nmap \cite{nmap}. Nesse modo, são verificadas apenas a portas especificadas no arquivo nmap-services, que por padrão, são descritas 27372 portas descritas nesse arquivo. Isso é muito mais rápido que verificar todas as 65535 portas existentes em um \textit{host}. Nesse teste nenhum IDs conseguiu detectar os \textit{scan} na rede.
