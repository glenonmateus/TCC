...
Diante da lista de vulnerabilidades encontradas com os \textit{scanners}, basta usar um \textit{exploit} adequado. Um \textit{exploit} são pequenos utilitários usados para explorar vulnerabilidades específicas, podendo serem usados de forma \textit{"stand alone"}, ou seja, serem usados diretamente, ou podem ser incorporados à \textit{malwares} \cite{exploit:cassio}.
